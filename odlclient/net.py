...
from odlclient.error import raise_errors
from odlclient.datatypes import LldpProperties
...
class NetMixin(ApiBase):
    ...
    def get_cluster_broadcast_tree(self, cluster_id):
        ...
        :rtype: odlclient.datatypes.Cluster
    ...
    def get_forward_path(self, src_dpid, dst_dpid):
        ...
        :rtype: odlclient.datatypes.Path
    ...
    def remove_lldp_suppressed(self, ports):
        ...
        :params odlclient.datatypes.LldpProperties ports:
    ...
    def create_diag_observation_post(self, observation):
        ...
        :param odlclient.datatypes.Observation observation:
    ...
    def get_diag_packet(self, packet_uid):
        ...
        :rtype: odlclient.datatypes.Packet
    ...
    def get_diag_packet_nexthop(self, packet_uid, dpid):
        ...
        :rtype: odlclient.datatypes.NextHop
