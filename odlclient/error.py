...
class OdlclientError(Exception):
    """Base class for Flare API errors"""
    pass


class InvalidJson(OdlclientError):
...
class VersionMismatch(OdlclientError):
...
class IllegalArgument(OdlclientError):
    def __init__(self, arguments=None):
        super(IllegalArgument, self).__init__()
        self.arguments = arguments


class NotFound(OdlclientError):
    def __init__(self, message):
        super(NotFound, self).__init__(message)


class OpenflowProtocolError(OdlclientError):
    def __init__(self):
...
class DatatypeError(OdlclientError):
