...
import odlclient.auth as auth
from odlclient.tests.data import AUTH
...
class AuthTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.user = 'odl'
        self.password = 'odl'
        self.auth = auth.Auth(self.server,
                              self.user,
                              self.password)

    def test_instantiate_xauthtoken(self):
        self.assertEqual(self.auth.server, self.server)
        self.assertEqual(self.auth.user, self.user)
